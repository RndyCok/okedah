...
📮Bot ini Belum full Rilis, Mohon maaf jika masih ada Bug
   Laporkan bug dengan cara ketik .report, Agar kami memperbaiki


*CLICK LIST BUTTON DI BAWAH*
          
    🗓️ ${new Date().toLocaleDateString()}
`
const listMessage = {
  text: tek,
  footer: '🍭Source Code by FangzXD\nYT: FangzXD',
