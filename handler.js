...
function _0x1f1f() {
	const _0x437a74 = ['fsizedoc', 'swb', 'ddocx', '\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20「\x20ᴡ\x20ᴇ\x20ʟ\x20ᴄ\x20ᴏ\x20ᴍ\x20ᴇ\x20」', '.owner', 'pdf', 'titlebot', '20hbclWI', '🌹Hallo', 'buffer', 'add', '264990qPCUgh', '1FJySAV', '🌺Author Bot', '21472385sSWBcX', '338802lIWcAV', '🎐Menu', '398673ExmgPg', '12nIokkC', '20eprFXu', '5195876jzJEuN', '550904LCnCzX', 'salken', '30495rpFhhV', '\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20「\x20ɢ\x20ᴏ\x20ᴏ\x20ᴅ\x20\x20ʙ\x20ʏ\x20ᴇ」', '.menu', 'sendMessage', '24PAoNmt', 'sig'];
	_0x1f1f = function() {
		return _0x437a74;
	};
	return _0x1f1f();
...
let buttonMessage = {
	...
	'contextInfo': {
		...
		'externalAdReply': {
			...
			'body': global['hiasan'],
			'thumbnail': await(await fetch(action == _0x3332b6(0x1dc) ? wel : lea))[_0x3332b6(0x1db)](),
			'sourceUrl': global.swb
		}
	},
	'caption': text,
...
function _0x2c3f(_0x406bfd, _0x5c1f55) {
	...
	return _0x2c3f = function(_0x2c3fe1, _0x434357) {
...
global.dfail = (type, m, conn) => {
    ...
    if (msg) return conn.reply(m.chat, msg, m, { contextInfo: { externalAdReply: { // jgn lupa parametersnya
    mediaUrl: global.sig,
    title: wm,
    ...
    let msgg = {
    	unreg: '*Upsss...*\nSepertinya Anda baru saja menggunakan bot ini.\n\nClick Verify di bawah\n\nType: .abaikan untuk menggunakan akun guest.'
}[type]
